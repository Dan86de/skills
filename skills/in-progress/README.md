...
Beta.
Public on purpose, feedback wanted, not shipped in the Claude Code plugin and not listed in the top-level [README.md](../../README.md).

`scripts/link-skills.sh` still links these locally, because daily use is how they get good enough to promote.
